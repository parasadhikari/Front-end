...
//since we create element using "createElement",So eventlistener for delete
...
function f2(event) 
{
    ...
    // console.dir(event)//event whole list...
    // console.dir(event.target)
    // console.dir(event.target.nodeName)//it tells what has been clicked li/ul/button....
    if (event.target.nodeName=="BUTTON") 
    {
